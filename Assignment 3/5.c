/* Write a program which will take an array as input from user (or hard coded inside program),
later it will take another two inputs: firstly, the position of an element and then the element.
The position should be within the range of the size of the array.
The new input will later replace the existing number in array at the index/position.*/
