...
of those matrices storing the result in another matrix.
Before performing the multiplication,
the two matrices need to go through a dimensionality check whether the matrices are of the size
M X N = N X P; meaning the number of columns in the first matrix should be equal to the number of
